...
public class InteceptorsConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginInteceptor).addPathPatterns("/**").excludePathPatterns("/htm/login.htm", "/htm/register.htm", "/htm/main.htm",
        "/htm/error.htm", "/htm/verifyCode.htm","/htm/loginManagerAccount.htm").excludePathPatterns("/**.ico","/**.png","/**.img","/*.js","/*.css");
